...
import { AreaSummary, GoalEntry, GoalStatus, DropReason, GoalFrontmatter } from "./types";
...
/** Pure function: patch YAML frontmatter with new status/dropReason. Exported for testing. */
